        ...
        <article className="mx-auto max-w-2xl">
          ...
          <div className="space-y-12 text-sm leading-relaxed text-foreground/80">
            <section>
              ...
              <p>
                By using OpenSprout, you agree to these terms. OpenSprout is
                provided as a free, open-source application under the AGPLv3
                license.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                for all activity under your account. You may delete your account
            ...
            <section>
              ...
              <p>
                You retain all rights to the plant data, photos, and journal
                entries you create. OpenSprout does not claim ownership of your
                content.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                OpenSprout is provided &quot;as is&quot; without warranty. The
                project is maintained as open-source software and may experience
                downtime or bugs.
              </p>
            </section>
