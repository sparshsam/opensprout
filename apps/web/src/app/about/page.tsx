      ...
      >
        <article className="mx-auto max-w-2xl">
          ...
          <p className="mb-16 max-w-xl text-lg leading-relaxed text-muted-foreground">
            A privacy-first plant care companion. Track watering, log care, and
            keep your plants thriving — without surveillance.
          </p>
          ...
          <div className="space-y-12 text-sm leading-relaxed text-foreground/80">
            <section>
              ...
              <p className="mb-3">
                Most plant care apps are surveillance products dressed in green.
                They track your data, sell your attention, and treat your garden
                like a spreadsheet.
              </p>
              <p>
                OpenSprout exists because plants deserve better — and so do you.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-semibold text-foreground">Add your plants</p>
                    <p className="text-muted-foreground">Name them, set a schedule, upload a photo.</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary text-xs font-bold">
                  ...
                  <div>
                    <p className="font-semibold text-foreground">Follow the care rhythm</p>
                    <p className="text-muted-foreground">OpenSprout tells you what each plant needs, when it needs it.</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-primary/10 text-primary text-xs font-bold">
                  ...
                  <div>
                    <p className="font-semibold text-foreground">Watch them grow</p>
                    <p className="text-muted-foreground">Log care, track trends, and build a living record of your collection.</p>
                  </div>
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="space-y-4">
                <li>
                  ...
                  <p className="text-muted-foreground">No tracking, no analytics, no data sales. You can export or delete everything at any time.</p>
                </li>
                <li>
                  <p className="font-semibold text-foreground">Open source, always.</p>
                  <p className="text-muted-foreground">The full source is on GitHub. Auditable, forkable, improvable.</p>
                </li>
                <li>
                  <p className="font-semibold text-foreground">Calm by design.</p>
                  <p className="text-muted-foreground">No notifications for notifications&apos; sake. The app supports your routine, it doesn&apos;t demand one.</p>
                </li>
              </ul>
            </section>
